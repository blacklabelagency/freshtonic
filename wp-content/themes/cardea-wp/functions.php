...
//JavaScript
		...
		$inlineCustomiserCss = CardeaWPLiveCSS::cardea_theme_customized_style();
		if($inlineCustomiserCss !== NULL){
			wp_add_inline_style('cardea-main-theme-style', $inlineCustomiserCss);
		}		        
    }
